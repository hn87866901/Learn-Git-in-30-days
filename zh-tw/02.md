...
第 1 套：[Git for Windows](https://git-for-windows.github.io/)
---------------------------------------------
...
* 先連到 http://git-for-windows.github.io/ 官網，準備下載安裝檔
...
* 選取元件，**建議取消勾選 Windows Explorer integration 選項！** <br>( 因為這套整合工具太陽春，建議改用 [TortoiseGit](https://tortoisegit.org/) 工具 )
...
> [GitHub for Windows](https://desktop.github.com/) 內建了一個 [Git Shell](https://github.com/dahlbyk/posh-git/) 工具，這工具會用到 [Git for Windows](http://git-for-windows.github.io/)，所以如果你沒有安裝 Git for Windows 的話，也將無法使用 GitHub for Windows 的 Git Shell 工具 。
...
* 先連到 https://desktop.github.com/ 準備下載安裝檔
...
> [SourceTree](http://www.sourcetreeapp.com/) 其實骨子裡也是透過 [Git for Windows](https://git-for-windows.github.io/) 工具進行版本操作，如果你沒有事先安裝 [Git for Windows](https://git-for-windows.github.io/) 的話，安裝的過程中他也會提示你要不要順便安裝起來。

[SourceTree](http://www.sourcetreeapp.com/) 的功能相較於 [GitHub for Windows](https://desktop.github.com/) 是強大許多，幾乎所有的指令列功能都能夠過 SourceTree 的 GUI 介面完成(透過滑鼠操作)，不過還是老話一句，如果你對 Git 的核心觀念不太了解，再多的右鍵選單對你來說等同於白紙一張，一樣不知道怎樣操作。但你若認真的了解 Git 的運作機制與觀念，使用 SourceTree 絕對能夠事半功倍！
...
第 4 套：[TortoiseGit](https://tortoisegit.org/)
-----------------------------------------------------------------
